		...
		this.config = {
			...
			aside_driver: {
				...
				items: [
					...
					{
						title: 'Segnalazioni del gestore',
						root: true,
						icon: 'flaticon-settings',
						page: '/reportNear'
					},
			...
			aside_owner: {
				...
				items: [
					{
						title: 'Gestione parcheggi',
						icon: 'flaticon-settings',
						page: '/managementPark',
					},
					{
						title: 'Inserisci parcheggi',
						icon: 'flaticon-settings',
						page: '/managementSlot'
					},
					{
					...
					{
						title: 'Segnalazioni degli utenti',
						icon: 'flaticon-settings',
						page: '/reportNearOwner'
					}
				]
			}
