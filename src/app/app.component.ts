import { HomeOwnerPage } from './../pages/home-owner/home-owner';
...
export class MyApp {
  ...
  ownerPages: Array<{title: string, component: any}>;
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen,public events: Events) {
    ...
    // used for an example of ngFor and navigation
    this.ownerPages = [
      { title: 'Home', component: HomeOwnerPage },
      { title: 'Avvisi', component: ReportOwnerPage },
      { title: 'Segnalazioni degli utenti', component: ReportNearPage },
      { title: 'Esci', component: LoginPage }
    ];
